...
const AirdropCalculator = () => {
  ...
  const epoch2Points = 11610000000 // 11.61B RH points
  const totalEpochs = 4
...
Epoch Distribution: E1: 4.66B | E2: 11.61B | E3: ${formData.epoch3Points} | E4: ${formData.epoch4Points}
...
Generated by AsterBot
  ...
  return (
    <div ref={calculatorRef} className="w-full mx-auto">
      <div className="glass rounded-xl p-4 sm:p-6 border border-primary-orange/20">
          ...
          <div className="bg-dark-800/30 border border-gray-600 rounded-lg p-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
              ...
              <div>
                ...
                <span className="text-white font-mono ml-1">11.61B</span>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <label className="flex items-center cursor-pointer">
                <input
                  ...
                  className="sr-only"
                />
                <div className={`w-full p-3 sm:p-2 rounded-lg border transition-all duration-200 text-center ${
                  ...
                  <span className="font-medium text-sm sm:text-xs">Daily</span>
                </div>
              </label>
              <label className="flex items-center cursor-pointer">
                <input
                ...
                <div className={`w-full p-3 sm:p-2 rounded-lg border transition-all duration-200 text-center ${
                  ...
                  <span className="font-medium text-sm sm:text-xs">Total</span>
                </div>
              </label>
            </div>
          </div>
