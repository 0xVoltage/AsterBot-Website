              ...
              <div className="bg-primary-orange/10 border border-primary-orange/30 rounded-xl p-4 text-center">
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="w-full bg-gradient-orange text-white px-4 py-2 rounded-lg font-semibold text-sm transition-all duration-300 hover:shadow-lg hover:shadow-primary-orange/25 flex items-center justify-center gap-2"
